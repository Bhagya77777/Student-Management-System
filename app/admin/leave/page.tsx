...
import { AlertCircle, Calendar as CalendarIcon, CheckCircle, Clock, FileText, Loader2, XCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-blue-50/30">
      <div className="flex h-screen overflow-hidden">
        <DashboardSidebar items={adminSidebarItems} activeItem="leave" />
        <div className="flex-1 flex flex-col overflow-hidden">
          <DashboardHeader title="Leave Management" />
          <main className="flex-1 overflow-auto p-6 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Leave Requests</h2>
              <p className="text-gray-500 text-sm mt-1">Review and manage student leave requests</p>
            </div>
